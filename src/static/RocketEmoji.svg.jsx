...
const RocketEmoji = () => (
  ...
  >
    <path
      d="M1 17L9 10L25 11L26 27L19 35C19 35 19.001 29.001 13 23C6.999 16.999 1 17 1 17Z"
      fill="#A0041E"
    />
    <path
    ...
    />
    <path
      d="M8.999 31C11.2081 31 12.999 29.2091 12.999 27C12.999 24.7909 11.2081 23 8.999 23C6.78986 23 4.999 24.7909 4.999 27C4.999 29.2091 6.78986 31 8.999 31Z"
      fill="#FFCC4D"
    />
    <path
    ...
    />
    <path
      d="M8 28C8 28 8 24 9 23C10 22 22.001 12.001 23 13C23.999 13.999 13.999 26 12.999 27C11.999 28 8 28 8 28Z"
      fill="#A0041E"
    />
  </svg>
)
