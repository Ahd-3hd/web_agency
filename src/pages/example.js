...
import { H1, H2, H3, H4, H5, Body1, Body2, Subtitle, ButtonText } from '../components/typography'
...
const UserIcon = ({ width }) => (
  <svg width={`${width}px`} viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
